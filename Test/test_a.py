...
parser.add_argument('--data_path', type=str, default ='/blue/eel6935/noplaxochia/1_GAN/Sparse-Depth-Completion/Gib', help='path to desired datasets')
...
def main():
    ...
    save_root = os.path.join(os.path.dirname(best_file_name), 'results_gib')
